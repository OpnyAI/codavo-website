...
export const metadata: Metadata = {
  title: "Webdesign & moderne Websites für Unternehmen | Codavo Webstudio",
  description:
    "Codavo Webstudio entwickelt moderne Websites und Web-Apps für Unternehmen, Dienstleister und Selbstständige. Schnell umgesetzt, technisch sauber und auf Performance optimiert.",
  alternates: {
    canonical: "/webdesign",
  },
  openGraph: {
        ...
        <div className="container max-w-4xl">
          ...
          <header className="mb-10">
            ...
            <h1 className="mt-3 text-3xl md:text-5xl font-semibold tracking-tight text-white">
              Webdesign für Unternehmen – Websites, die wirklich Anfragen
              bringen
            </h1>
            ...
            <p className="mt-4 text-slate-300 text-sm md:text-base">
              Je nach Ziel passt ein anderes Setup:{" "}
              <Link
                href="/webdesign-stuttgart"
          ...
          {/* CTA */}
          <section className="mt-12 section rounded-2xl border border-indigo-500/40 bg-indigo-500/10 p-6 md:p-8">
            <h2 className="text-xl md:text-2xl font-semibold text-white">
