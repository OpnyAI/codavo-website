        ...
        <div className="container max-w-4xl">
          ...
          <header className="mb-10">
            ...
            <p className="mt-4 text-slate-300 text-sm md:text-base">
              ...
              dir wirklich neue Anfragen bringt – statt nur „schön“
              auszusehen.{" "}
            </p>{" "}
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-300">
                  ...
                  man dich wählen sollte – ohne
                  Marketing-Buzzword-Overkill.{" "}
                </p>{" "}
              </div>{" "}
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                {" "}
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-300">
                  ...
                  Kontaktanfragen, Buchungen oder Leads im Mittelpunkt
                  stehen.{" "}
                </p>{" "}
              </div>{" "}
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <ul className="mt-2 space-y-1 text-xs md:text-sm text-slate-300">
                  {" "}
                  <li>
                    • Individuelles Design statt generischer Templates
                  </li>{" "}
          ...
          <section className="mt-12 section">
            ...
            <ol className="mt-4 space-y-3 text-sm md:text-base text-slate-300">
              ...
              <li>
                ...
                – telefonisch oder per Video: Ziele, Status Quo,
                Budgetrahmen.{" "}
              </li>{" "}
              <li>
                {" "}
              ...
              <li>
                ...
                Domain, Hosting, Launch und kleiner Feinschliff nach dem
                Start.{" "}
              </li>{" "}
            </ol>{" "}
          </section>{" "}
