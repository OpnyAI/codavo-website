        ...
        <div className="mt-8 space-y-8 text-sm md:text-base text-slate-200">
          ...
          <section>
            ...
            <p className="mt-2 text-slate-300">
              ...
              Bereitstellung dieser Website, zur Kommunikation mit dir oder zur
              Vorbereitung und Durchführung von Projekten erforderlich ist.
              Rechtsgrundlagen sind insbesondere Art. 6 Abs. 1 lit. a, b und f
              DSGVO.
            </p>
            <p className="mt-2 text-slate-300">
          ...
          <section>
            ...
            <p className="mt-2 text-slate-300">
              Unsere Website wird bei einem externen Dienstleister (Hosting-
              Provider) betrieben. Beim Aufruf unserer Website werden durch
              diesen Provider automatisch Informationen erfasst und in
          ...
          <section>
            ...
            <p className="mt-2 text-slate-300">
              Wir setzen auf dieser Website keine Tracking- oder Marketing-
              Cookies von Drittanbietern ein. Technisch notwendige Cookies bzw.
              vergleichbare Technologien (z. B. lokale Speicherung im Browser)
              können eingesetzt werden, um Sicherheit, Spamschutz oder eine
              stabile Darstellung der Seite sicherzustellen. Rechtsgrundlage ist
          ...
          <section>
            ...
            <p className="mt-2 text-slate-300">
              ...
              verarbeiten wir deine Angaben (z. B. Namen, Kontaktdaten, Inhalte
              der Anfrage) zum Zweck der Bearbeitung und Beantwortung deiner
              Anfrage sowie zur Vorbereitung bzw. Durchführung eines Projekts.
            </p>
            <p className="mt-2 text-slate-300">
            ...
            <h3 className="mt-4 text-base font-semibold text-white">E-Mail</h3>
            <p className="mt-2 text-slate-300">
              ...
              Korrespondenz so lange auf, wie es zur Bearbeitung deiner Anfrage,
              zur Vertragsdurchführung oder aufgrund gesetzlicher
              Aufbewahrungspflichten erforderlich ist.
            </p>

            <h3 className="mt-4 text-base font-semibold text-white">Telefon</h3>
            <p className="mt-2 text-slate-300">
              Wenn du uns anrufst, können wir – soweit erforderlich – Notizen zu
              deinem Anliegen erstellen (z. B. Projektskizze, Kontaktdaten,
              To-Dos). Diese Informationen werden nur intern verwendet und nicht
              an Dritte weitergegeben, sofern keine rechtliche Verpflichtung
              besteht.
            </p>
            ...
            <p className="mt-2 text-slate-300">
              ...
              mit dir (z. B. zur Terminabstimmung, Projektanbahnung oder Klärung
              von Fragen). Rechtsgrundlage ist Art. 6 Abs. 1 lit. b DSGVO
              (Vertragsanbahnung/-durchführung) und Art. 6 Abs. 1 lit. f DSGVO
              (berechtigtes Interesse an einer schnellen und einfachen
              Kommunikation).
            </p>
            <p className="mt-2 text-slate-300">
              Bitte sende uns über WhatsApp keine besonders sensiblen Daten (z.
              B. vertrauliche Geschäftsgeheimnisse). Du kannst jederzeit
              verlangen, dass wir den Chatverlauf auf unseren Geräten löschen;
              die Löschung bei WhatsApp selbst liegt außerhalb unseres direkten
              Einflussbereichs.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-2 text-slate-300">
              Teilweise bedienen wir uns zur Verarbeitung deiner Daten externer
              Dienstleister (z. B. Hosting-Provider, E-Mail-Provider). Diese
              werden von uns sorgfältig ausgewählt und vertraglich nach Art. 28
              DSGVO auf die Einhaltung des Datenschutzes verpflichtet.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-2 list-disc list-inside text-slate-300">
              ...
              <li>
                Widerspruchsrecht gegen die Verarbeitung auf Grundlage von Art.
                6 Abs. 1 lit. f DSGVO
              </li>
              <li>
                Beschwerderecht bei einer Datenschutzaufsichtsbehörde, wenn du
                der Ansicht bist, dass die Verarbeitung deiner personenbezogenen
                Daten gegen die DSGVO verstößt
              </li>
            </ul>
            <p className="mt-2 text-slate-300">
              Zur Ausübung deiner Rechte genügt eine formlose Mitteilung, z. B.
              per E-Mail an: kontakt@codavo-webstudio.de
            </p>
          </section>
