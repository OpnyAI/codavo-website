  ...
  return (
    <>
      <main className="min-h-screen pt-28 md:pt-32 lg:pt-36 pb-20">
        ...
        <section className="section">
          <div className="container mt-10 md:mt-6 lg:mt-4">
            ...
            <p className="mt-4 text-slate-300 max-w-2xl">
              Codavo Webstudio entwickelt Websites und Web-Apps, die nicht nur
              gut aussehen, sondern messbar etwas bringen. Wir arbeiten remote
              mit Kund:innen in ganz Deutschland und der DACH-Region – mit
              klaren Prozessen und kurzen Projektlaufzeiten von etwa{" "}
        ...
        {/* Prozess & Speed */}
        <section className="section">
          <div className="container mt-16 grid gap-10 md:grid-cols-[minmax(0,2fr)_minmax(0,1.5fr)] items-start">
            <div>
          ...
          <div className="container mt-16">
            <div className="card text-center">
              ...
              <p className="mt-3 text-slate-300 max-w-xl mx-auto text-sm md:text-base">
                Schick ein paar Stichpunkte zu dir und deinem Projekt – wir
                melden uns in der Regel innerhalb von 24–48 Stunden mit einer
