...
export const metadata: Metadata = {
  title: "Leistungen – Websites & Web-Apps | Codavo Webstudio",
  description:
    "Codavo Webstudio entwickelt moderne Websites, Landingpages und Web-Apps für Kund:innen in ganz Deutschland und der DACH-Region – mit Fokus auf Geschwindigkeit (1–4 Wochen), Performance und klare UX.",
};
    ...
    <main className="pt-28 pb-16">
      ...
      <section className="container mt-10 grid gap-6 md:grid-cols-3">
        <div className="card h-full">
          <h2 className="text-xl font-semibold text-white">Moderne Websites</h2>
      ...
      <section className="container mt-16 grid gap-10 md:grid-cols-[minmax(0,2fr)_minmax(0,1.5fr)] items-start">
        <div>
          ...
          <p className="mt-4 text-slate-300">
            ...
            Go-Live. Entscheidungen werden früh getroffen, damit du schnell live
            bist – in der Regel in{" "}
            <span className="text-white font-medium">1–4 Wochen</span>, je nach
            Umfang.
          </p>
        ...
        <div className="card">
          ...
          <p className="mt-4 text-sm text-slate-300">
            Wenn dir Tempo, saubere Technik und ein aufgeräumtes Design wichtig
            sind, passen wir wahrscheinlich gut zusammen.
          </p>
        </div>
      </section>
      ...
      <section className="container mt-16">
        <div className="card text-center">
          ...
          <p className="mt-3 text-slate-300 max-w-xl mx-auto text-sm md:text-base">
            ...
            uns in der Regel innerhalb von 24–48 Stunden mit einer Einschätzung
