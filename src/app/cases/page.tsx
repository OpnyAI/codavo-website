        ...
        <section className="section">
          <div className="container">
            ...
            <p className="mt-4 text-slate-300 max-w-2xl">
              Eine Auswahl von Projekten, bei denen wir Websites oder Web-Apps
              für Kund:innen aus Deutschland und der DACH-Region umgesetzt
              haben. Unterschiedliche Branchen, aber immer mit einem klaren
              Ziel: ein Auftritt, der für das Unternehmen arbeitet.
            </p>
          </div>
        </section>
