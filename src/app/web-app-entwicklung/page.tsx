...
export const metadata: Metadata = {
  title:
    "Web App Entwicklung – Kundenportale & Dashboards | Codavo Webstudio",
  description:
    "Web App Entwicklung für Unternehmen: Wir bauen Kundenportale, Dashboards und interne Tools mit klarem Prozess, modernem Stack und Fokus auf Performance, Sicherheit und Skalierbarkeit.",
  alternates: {
    canonical: "https://www.codavo-webstudio.de/web-app-entwicklung",
  },
  robots: {
    index: true,
    follow: true,
  ...
  openGraph: {
    type: "website",
    locale: "de_DE",
    url: "https://www.codavo-webstudio.de/web-app-entwicklung",
    siteName: "Codavo Webstudio",
    title:
      "Web App Entwicklung – Kundenportale & Dashboards | Codavo Webstudio",
    description:
      "Individuelle Web App Entwicklung für Unternehmen: Kundenportale, Dashboards, interne Tools und SaaS MVPs mit React, Next.js und API-Anbindungen.",
    images: [
      {
        url: "/og.jpg",
        width: 1200,
        height: 630,
        alt: "Codavo Webstudio – Web App Entwicklung",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "Web App Entwicklung – Codavo Webstudio",
    description:
      "Kundenportale, Dashboards und Web-Apps mit klarem Ablauf, sauberer Technik und schneller Umsetzung.",
    images: ["/og.jpg"],
  },
};
        ...
        <div className="container max-w-4xl">
          <header className="mb-10">
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-indigo-300">
              Web App Entwicklung · Unternehmen · DACH-weit
            </p>
            ...
            <p className="mt-4 text-slate-300 text-sm md:text-base">
              Wir entwickeln individuelle Web-Apps, die Prozesse vereinfachen
              und Teams produktiver machen. Ob Kundenportal, Dashboard oder
              internes Tool: Die Lösung richtet sich nach deinem Alltag, nicht
              nach einem Standard-Template.
            </p>
          </header>
          ...
          <section className="mt-12">
            ...
            <div className="mt-4 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/5 p-4">
                ...
                <p className="mt-2 text-xs md:text-sm text-slate-300">
                  Kurze Ladezeiten, klare Zugriffslogik und skalierbare
          ...
          <section className="mt-12">
            ...
            <ol className="mt-4 space-y-3 text-sm md:text-base text-slate-300">
              ...
              <li>
                ...
                - Funktionen priorisieren, Nutzerflüsse planen, Struktur
                definieren.
              </li>
              <li>
          ...
          <section className="mt-12 rounded-2xl border border-indigo-500/40 bg-indigo-500/10 p-6 md:p-8">
            ...
            <p className="mt-3 text-sm md:text-base text-slate-200">
              ...
              willst, lass uns kurz sprechen. Wir klären Scope, Timeline und
              den passenden technischen Weg für dein Projekt.
            </p>
